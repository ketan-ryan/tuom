...
public class OpalFuser extends Block implements ITileEntityProvider
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool ACTIVE = PropertyBool.create("burning");
	
	public OpalFuser(String name) 
	{
		super(Material.IRON);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(TUOM.instance(), TUOM.GUI_OPAL_FUSER, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) 
	{
		if(!worldIn.isRemote)
		{
			...
			//Sets face to opposite direction player is facing
	...
	{
		return new TileEntityOpalFuser();
	}
	...
	{
		TileEntityOpalFuser tileentity = (TileEntityOpalFuser) worldIn.getTileEntity(pos);
