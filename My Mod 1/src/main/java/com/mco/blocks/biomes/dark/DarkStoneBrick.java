...
public class DarkStoneBrick extends Block
{
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private static final DarkStoneBrick.EnumType[] META_LOOKUP = new DarkStoneBrick.EnumType[values().length];
        ...
        public static DarkStoneBrick.EnumType byMetadata(int meta)
        {
        ...
        static
        {
            for (DarkStoneBrick.EnumType blockstonebrick$enumtype : values())
            {
