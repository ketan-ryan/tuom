...
public class LayerDarkOpalDeath implements LayerRenderer<EntityDarkOpalDemon>
{
	public void doRenderLayer(EntityDarkOpalDemon entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        if (entitylivingbaseIn.getDeathTicks() > 0)
        {
            ...
            GlStateManager.translate(1.0F, -4.0F, 0.0F);
