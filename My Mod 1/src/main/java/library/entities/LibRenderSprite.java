...
public class LibRenderSprite extends Render<Entity>
{
    private ResourceLocation texture;
    private final float scale;

    public LibRenderSprite(RenderManager renderManagerIn, ResourceLocation texture, float scaleIn)
    {
    ...
    public LibRenderSprite setTexture(ResourceLocation texture) {
        this.texture = texture;
        return this;
    }
