...
public class LibEntityShulker extends LibEntityGolem implements IMob {

    /** COMMON VARIABLES **/

    // Sounds
    protected SoundEvent ambientSound = SoundEvents.ENTITY_SHULKER_AMBIENT;
    protected SoundEvent deathSound = SoundEvents.ENTITY_SHULKER_DEATH;
    protected SoundEvent hurtClosedSound = SoundEvents.ENTITY_SHULKER_HURT_CLOSED;
    protected SoundEvent hurtSound = SoundEvents.ENTITY_SHULKER_HURT;
    protected SoundEvent teleportSound = SoundEvents.ENTITY_SHULKER_TELEPORT;
    protected SoundEvent closeSound = SoundEvents.ENTITY_SHULKER_CLOSE;
    protected SoundEvent openSound = SoundEvents.ENTITY_SHULKER_OPEN;
    protected SoundEvent shootSound = SoundEvents.ENTITY_SHULKER_SHOOT;

    // Loot table
    protected ResourceLocation lootTable = LootTableList.ENTITIES_SHULKER;
    ...
    protected void initEntityAI() {
        ...
        this.tasks.addTask(4, new LibEntityShulker.AIAttack());
        this.tasks.addTask(7, new LibEntityShulker.AIPeek());
        this.tasks.addTask(8, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true, new Class[0]));
        this.targetTasks.addTask(2, new LibEntityShulker.AIAttackNearest(this));
        this.targetTasks.addTask(3, new LibEntityShulker.AIDefenseAttack(this));
    }
    ...
    protected SoundEvent getHurtSound(DamageSource p_184601_1_) {
        return this.isClosed() ? hurtClosedSound : hurtSound;
    }
    ...
    protected static final DataParameter<EnumFacing> ATTACHED_FACE = EntityDataManager.<EnumFacing>createKey(LibEntityShulker.class, DataSerializers.FACING);
    protected static final DataParameter<Optional<BlockPos>> ATTACHED_BLOCK_POS = EntityDataManager.<Optional<BlockPos>>createKey(LibEntityShulker.class, DataSerializers.OPTIONAL_BLOCK_POS);
    protected static final DataParameter<Byte> PEEK_TICK = EntityDataManager.<Byte>createKey(LibEntityShulker.class, DataSerializers.BYTE);
    protected static final DataParameter<Byte> COLOR = EntityDataManager.<Byte>createKey(LibEntityShulker.class, DataSerializers.BYTE);
    ...
    public LibEntityShulker(World worldIn) {
        super(worldIn);
    ...
    protected EntityBodyHelper createBodyHelper() {
        return new LibEntityShulker.BodyHelper(this);
    }

    public static void registerFixesShulker(DataFixer fixer) {
        EntityLiving.registerFixesMob(fixer, LibEntityShulker.class);
    }
            ...
            if (d5 > 0.0D) {
                ...
                if (!list.isEmpty()) {
                    for (Entity entity : list) {
                        if (!(entity instanceof LibEntityShulker) && !entity.noClip) {
    ...
    public void updateArmorModifier(int p_184691_1_) {
        if (!this.world.isRemote) {
            ...
            if (p_184691_1_ == 0) {
                ...
                this.playSound(closeSound, 1.0F, 1.0F);
            } else {
                this.playSound(openSound, 1.0F, 1.0F);
            }
        }
    ...
    public class AIAttack extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            EntityLivingBase entitylivingbase = LibEntityShulker.this.getAttackTarget();

            if (entitylivingbase != null && entitylivingbase.isEntityAlive()) {
                return LibEntityShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL;
            } else {
                return false;
            }
        }
        ...
        public void startExecuting() {
            this.attackTime = 20;
            LibEntityShulker.this.updateArmorModifier(100);
        }
        ...
        public void resetTask() {
            LibEntityShulker.this.updateArmorModifier(0);
        }
        ...
        public void updateTask() {
            if (LibEntityShulker.this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
                --this.attackTime;
                EntityLivingBase entitylivingbase = LibEntityShulker.this.getAttackTarget();
                LibEntityShulker.this.getLookHelper().setLookPositionWithEntity(entitylivingbase, 180.0F, 180.0F);
                double d0 = LibEntityShulker.this.getDistanceSq(entitylivingbase);

                if (d0 < 400.0D) {
                    if (this.attackTime <= 0) {
                        this.attackTime = 20 + LibEntityShulker.this.rand.nextInt(10) * 20 / 2;
                        EntityShulkerBullet entityshulkerbullet = new EntityShulkerBullet(LibEntityShulker.this.world, LibEntityShulker.this, entitylivingbase, LibEntityShulker.this.getAttachmentFacing().getAxis());
                        LibEntityShulker.this.world.spawnEntity(entityshulkerbullet);
                        LibEntityShulker.this.playSound(shootSound, 2.0F, (LibEntityShulker.this.rand.nextFloat() - LibEntityShulker.this.rand.nextFloat()) * 0.2F + 1.0F);
                    }
                } else {
                    LibEntityShulker.this.setAttackTarget(null);
                }
    ...
    public class AIAttackNearest extends EntityAINearestAttackableTarget<EntityPlayer> {
        public AIAttackNearest(LibEntityShulker shulker) {
        ...
        @Override
        public boolean shouldExecute() {
            return LibEntityShulker.this.world.getDifficulty() == EnumDifficulty.PEACEFUL ? false : super.shouldExecute();
        }

        @Override
        protected AxisAlignedBB getTargetableArea(double targetDistance) {
            EnumFacing enumfacing = ((LibEntityShulker) this.taskOwner).getAttachmentFacing();
    ...
    public static class AIDefenseAttack extends EntityAINearestAttackableTarget<EntityLivingBase> {
        public AIDefenseAttack(LibEntityShulker shulker) {
    ...
    public class AIPeek extends EntityAIBase {
        ...
        @Override
        public boolean shouldExecute() {
            return LibEntityShulker.this.getAttackTarget() == null && LibEntityShulker.this.rand.nextInt(40) == 0;
        }
        ...
        public boolean shouldContinueExecuting() {
            return LibEntityShulker.this.getAttackTarget() == null && this.peekTime > 0;
        }
        ...
        @Override
        public void startExecuting() {
            this.peekTime = 20 * (1 + LibEntityShulker.this.rand.nextInt(3));
            LibEntityShulker.this.updateArmorModifier(30);
        }
        ...
        @Override
        public void resetTask() {
            if (LibEntityShulker.this.getAttackTarget() == null) {
                LibEntityShulker.this.updateArmorModifier(0);
            }
        }
