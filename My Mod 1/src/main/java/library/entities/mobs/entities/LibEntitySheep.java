...
public class LibEntitySheep extends LibEntityGenericPassive implements net.minecraftforge.common.IShearable
{

    /** COMMON VARIABLES **/

    // Sounds
    protected SoundEvent ambientSound = SoundEvents.ENTITY_SHEEP_AMBIENT;
    protected SoundEvent hurtSound = SoundEvents.ENTITY_SHEEP_HURT;
    protected SoundEvent deathSound = SoundEvents.ENTITY_SHEEP_DEATH;
    protected SoundEvent stepSound = SoundEvents.ENTITY_SHEEP_STEP;

    // Loot table
    protected ResourceLocation lootTable = LootTableList.ENTITIES_SHEEP;
    ...
    protected void applyEntityAttributes()
    {
        ...
        double maxHealth = 8.0D; // max health
    ...
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.<Byte>createKey(LibEntitySheep.class, DataSerializers.BYTE);
    /**
    ...
    public LibEntitySheep(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, LibEntitySheep.class);
    }
    ...
    {
        int i = ((LibEntitySheep)father).getFleeceColor().getDyeDamage();
        int j = ((LibEntitySheep)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j);
        ItemStack itemstack = CraftingManager.findMatchingResult(this.inventoryCrafting, ((LibEntitySheep)father).world);
        int k;
