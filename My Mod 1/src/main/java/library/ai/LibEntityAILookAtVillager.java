...
public class LibEntityAILookAtVillager extends EntityAIBase {
    private final LibEntityIronGolem ironGolem;
    private EntityVillager villager;
    private int lookTime;

    public LibEntityAILookAtVillager(LibEntityIronGolem ironGolemIn) {
